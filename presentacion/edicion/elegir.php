...
switch ($_GET["v"]) {
    ...
    case '-1': { //plantilla inicial
            Eliminar("../../pagina/*");
            full_copy("../../plantillas/General/", "../../pagina/");
        }
        break;
    case '0': { //secciones galeria
            full_copy("../../plantillas/galeria/galeria" . $_GET["tipo"] . ".php", "../../pagina/presentacion/seccion" . $total . ".php");
        }
        break;
    case '1': { //secciones imagen + texto
            full_copy("../../plantillas/ImagenTexto/imagenTexto" . $_GET["tipo"] . ".php", "../../pagina/presentacion/seccion" . $total . ".php");
        }
        break;
    case '2': { //secciones texto
            full_copy("../../plantillas/Texto/texto" . $_GET["tipo"] . ".php", "../../pagina/presentacion/seccion" . $total . ".php");
        }
        break;
    case '3': { //secciones video
            full_copy("../../plantillas/Video/video" . $_GET["tipo"] . ".php", "../../pagina/presentacion/seccion" . $total . ".php");
        }
        break;
}
