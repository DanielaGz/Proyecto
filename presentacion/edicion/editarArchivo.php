...
if (isset($_GET["ed"])) {
    switch ($_GET["ed"]) {
        ...
        case 'Titulo': {
            ...
            break;
        case 'Agregar': {
                Editar("<!-- Nueva -->", "../../pagina/inicio/inicio.php", "\t<!-- Seccion" . $_GET["val"] . " --><div id='Seccion" . $_GET["val"] . "' class='selec'><?php include 'seccion" . $_GET["val"] . ".php' ?></div>" . PHP_EOL . "\t<!-- Nueva -->");
            }
            break;
        case 'Menu': {
            ...
            break;
        case 'Seleccionar': {
                Editar("<!-- Seccion" . $_GET["val"] . " -->", "../../pagina/inicio/inicio.php", "\t<!-- Seccion" . $_GET["val"] . " --><div id='Seccion" . $_GET["val"] . "' class='selec'><div class='seleccionado'></div><?php include 'seccion" . $_GET["val"] . ".php' ?></div>");
            }
            break;
        case 'Deselec': {
                Editar("<!-- Seccion" . $_GET["val"] . " -->", "../../pagina/inicio/inicio.php", "\t<!-- Seccion" . $_GET["val"] . " --><div id='Seccion" . $_GET["val"] . "' class='selec'><?php include 'seccion" . $_GET["val"] . ".php' ?></div>");
            }
            break;
        case 'Tipo': {
                echo Tipo($_GET["val"]);
            ...
            break;
        case 'Imagenes': {
                Editar(" cantidad ", "../../pagina/inicio/seccion" . $_GET["sec"] . ".php", "\t\t/* cantidad */ \$num = " . $_GET["cant"] . ";");
            }
            break;
        case 'Imagenes2': {
                Editar("<!-- imagen -->", "../../pagina/inicio/seccion" . $_GET["sec"] . ".php", "\t\t<!-- imagen --><img src='img/" . $_GET["val"] . "<?php echo \$i ?>.png' id='img' class='img-fluid' alt='Responsive image'>");
            }
            break;
        case 'ImagTexto': {
                Editar("<!-- " . $_GET["edi"] . " -->", "../../pagina/inicio/seccion" . $_GET["sec"] . ".php", "\t\t<!-- " . $_GET["edi"] . " -->" . $_GET["val"]);
            }
            break;
        case 'ImagenesIT': {
                Editar("<!-- imagen -->", "../../pagina/inicio/seccion" . $_GET["sec"] . ".php", "\t\t<!-- imagen --><img src='img/" . $_GET["val"] . "<?php echo \$i ?>.png' class='img-fluid' alt='Responsive image'>");
            }
            break;
        case 'menuEdit': {
            ...
            break;
        case 'Video': {
                Editar("<!-- Url -->", "../../pagina/inicio/seccion" . $_GET["sec"] . ".php", "\t<!-- Url --><iframe class='embed-responsive-item' src='" . $_GET["val"] . "' allowfullscreen style='border-radius: 1vmax;'></iframe>");
            }
            break;
        case 'Eliminar': {
                Editar("<!-- Seccion" . $_GET["sec"] . " -->", "../../pagina/menu.php", "\t");
                Editar("<!-- Seccion" . $_GET["sec"] . " -->", "../../pagina/inicio/inicio.php", "\t");
                eliminar("../../pagina/inicio/seccion" . $_GET["sec"] . ".php", $_GET["sec"], $total);
            }
            break;
    }
}
...
function Tipo($url)
{
    $tipo = 0;
    if ($url != '0') {
        $archivo = "../../pagina/inicio/seccion" . $_GET["val"] . ".php";
